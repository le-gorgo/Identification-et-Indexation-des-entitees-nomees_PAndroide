        ...
        for occurence in mot[1]:
            ...
            if (n > 0):
                ...
                try:
                    ...
                    bool = 1
                if pred != "NoTag" and pred != "" and bool == 0:
                    print("Est ce que c'est un " + pred)
                    print("1. OUI")
                    print("2. NON")
                    n = eval(input("Choix? "))
                    if (n == 1):
                        ...
                        for dico in dicos:
                            ...
                            if dico == pred :
                                ...
                                max_id = max_id + 1
                                if (c == 1):
                                    dicos[j - 1][1][str(max_id)] = ([mot[0]], [occurence])
                                elif (c == 2):

                                    dicos[j - 1][1][str(max_id)] = ([mot[0]], [])
                                    for occ in mot[1]:
                                        dicos[j - 1][1][str(max_id)][1].append(occ)
                                    break
                                break
                    elif (n == 2): bool = 1
                else : bool = 1
